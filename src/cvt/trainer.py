...
from .metrics import MetricsTracker, AverageMeter, compute_text_detection_metrics, format_metrics_string
    ...
    def validate(self, val_loader, epoch: int) -> dict:
        ...
        with torch.no_grad():
            for batch in track(val_loader, description=f"Validation {epoch}"):
                ...
                detection_metrics = compute_text_detection_metrics(
                    outputs['binary_map'], gt_text
                )
